(ns starnet.kafka-samples.serde-compare
  (:require
...
(comment
  ...
  (def app2 (create-streams-app {:app-id "example.serde-compare.transit.streams"
                                 ...
                                 :key-serde-str "starnet.alpha.aux.serdes.TransitJsonSerde"
                                 :value-serde-str "starnet.alpha.aux.serdes.TransitJsonSerde"}))
  ...
  (def consumer-fu2 (future-call-consumer {:topic "example.serde-compare.transit.out"
                                           :key-des "starnet.alpha.aux.serdes.TransitJsonDeserializer"
