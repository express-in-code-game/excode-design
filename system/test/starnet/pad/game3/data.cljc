(ns starnet.alpha.core.game.data
  (:require
   ...
   #?(:cljs [starnet.alpha.core.macros :refer-macros [defmethod-set derive-set]]
      :clj  [starnet.alpha.core.macros :refer [defmethod-set derive-set]])))
