(ns starnet.alpha.streams1
  ...
  (:import
   ...
   starnet.alpha.aux.serdes.NippySerde
...
(defn future-call-consumer
  [{:keys [topic
           ...
           value-des
           recordf]
    :or {key-des "starnet.alpha.aux.serdes.TransitJsonDeserializer"
         value-des "starnet.alpha.aux.serdes.TransitJsonDeserializer"}
    :as opts}]
  (future-call
   (fn []
...
#_(defn create-kstreams-game-1
    ...
    (let [props {"application.id" "alpha.access.streams"
                 ...
                 "default.key.serde" "starnet.alpha.aux.serdes.TransitJsonSerde"
                 "default.value.serde" "starnet.alpha.aux.serdes.TransitJsonSerde"
...
(defn create-kstreams-crux-docs
  ...
  (let [props {"application.id" "alpha.kstreams.crux-docs"
               "bootstrap.servers" "broker1:9092"
               "auto.offset.reset" "earliest" #_"latest"
               "default.key.serde" "starnet.alpha.aux.serdes.NippySerde"
               "default.value.serde" "starnet.alpha.aux.serdes.NippySerde"
               "topology.optimization" "all"}]
    (create-streams
     props
     (fn []
