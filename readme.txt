...
- what's the point of the program ?
    ...
    - no usernames in the game - only colors
...
- rebase or merge?
  - merge
- words not to use?
  - refactor, fix, update, util(s), helper, play with, controller/manager, factory, wrap, etc, misc, cleanup, service, org, todo, archive, trash
- nesting?
